      ...
      >
        ...
        <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group">
                        ...
                        {errors && errors.phone && <span className="text-danger">This field is required</span>}
                    </div>
                    <div className="form-group">
                        <input type="text" name="email" {...register('email', { required: true })} placeholder="Email" className="form-control" />
                        {errors && errors.email && <span className="text-danger">This field is required</span>}
                    </div>
                    <div className="form-group row">
                        <div className="col-4">
                            ...
                            {errors && errors.gender && <span className="text-danger">This field is required</span>}

                        </div>
                        <div className="col-4">
                            <input className="form-control" name="age" {...register('age', { required: true })} placeholder="Your Age" type="number" />
                            {errors && errors.age && <span className="text-danger">This field is required</span>}
                        </div>
                        <div className="col-4">
                            <input className="form-control" name="weight" {...register('weight', { required: true })} placeholder="Weight" type="number" />
                            {errors && errors.weight && <span className="text-danger">This field is required</span>}
                        </div>
                    </div>
